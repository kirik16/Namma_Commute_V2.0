        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              _navItem(1, Icons.traffic_rounded, 'Traffic'),
              _navItem(2, Icons.train_rounded, 'Metro'),
              _navItem(3, Icons.report_problem_rounded, 'Report'),
              _navItem(4, Icons.emergency_rounded, 'SOS'),
              _navItem(5, Icons.people_rounded, 'About'),
            ],
          ),
        ),
      ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            Icon(icon, color: isActive ? color : Colors.white38, size: 22),
